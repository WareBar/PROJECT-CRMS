...
g = MD.CTkButton(login, text="Forgot password?", font=("Corbel", 10), width=272, hover_color="Red", text_color="Black",fg_color="#D9D9D9",bg_color="#D9D9D9",corner_radius=0,command=lambda:interface())
